...
<% 
	...
	final TDPoint location = TDUserService.getUserLocation(request);
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<!-- html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" xmlns:fb="http://www.facebook.com/2008/fbml" -->
<meta name="bitly-verification" content="dc0d8ce89d0e"/>
...
<head>
    ...
    <script type="text/javascript" src="http://www.google.com/jsapi?key=AIzaSyCJRsz9-xAYDU_SK9E6cyIeJ5xsGp9-W5o"></script>
...
<body>
    <div class="mask">
                    ...
                    <div id="header_search_bar_container">
                        <div class="search">
                            <form action="search.jsp" method="post">
							  ...
							  %>
                               	  ...
                               	  <input class="locationbox locationbox_up" name="loc" id="loc" type="text" value="<%= location.getAddress() %>" />
                               	  <input class="searchbox_submit" type="submit" value="" id="submitId"/>
                               	  <input type="hidden" id="user_lat" name="user_lat" value="<%= location.getLat() %>" />
                               	  <input type="hidden" id="user_lng" name="user_lng" value="<%= location.getLon() %>" />
                        ...
                        <div id="header_search_bar_quicklinks">
                            <ul>
								...
								{
									%><a href="<%=TDUserService.getLogoutURL()%>">Log Out</a><%
								}
								%></li>
                            </ul>
                        </div>
		...
		<div class="main_wrapper">
       	  ...
       	  <div id="filter_list">
       	  	<ul>
       	  	   <li class="hover closed">
       	  			...
       	  			<ul>
       	  			<%
       	  			final List<Tag> cuisines = new ArrayList<Tag>(TagUtils.getTagsByType(Tag.TYPE_CUISINE));
       	  			Collections.sort(cuisines, new TagNameComparator());
					for (Tag c : cuisines) {
						...
						out.print(generateHoverTextIfNecessary(c.getName()) + ">" 
							     + c.getName() + "</li>");
					}
       	  			%>
       	  			</ul>
					...
					%>
       	  		...
       	  		<li class="hover closed" >
       	  			...
       	  			<ul >
       	  			<%
       	  			final List<Tag> lifestyles = new ArrayList<Tag>(TagUtils.getTagsByType(Tag.TYPE_LIFESTYLE));
					...
					for (Tag l : lifestyles) {
						...
						out.print(generateHoverTextIfNecessary(l.getName()) + ">" 
							     + l.getName() + "</li>");
					}
					%>
       	  			</ul>
					...
					<%
						...
						out.print(generateHoverTextIfNecessary(p.getName()) + ">" 
							     + p.getName() + "</li>");
					}
					%>
       	  			</ul>
                ...
                <%!
       	  		    public String generateHoverTextIfNecessary(String tagName) {
       	  	            final int MAX_TAG_LENGTH_IN_CHARACTERS = 12;
       	  	            if (tagName.length() > MAX_TAG_LENGTH_IN_CHARACTERS) {
          ...
          <div id="fork"></div>
          <div id="coffee_circle"></div>
          <div id="mustard_stain"></div>
