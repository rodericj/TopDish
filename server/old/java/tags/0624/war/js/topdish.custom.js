	...
	function closeFilter()
	{
	 ...
	 function loadTopDishesOnFilter() { 
		...
		$.ajax({
			...
			data: "callType="+ajaxCallType+"&searchWord="+searchWord+"&location="+location+"&cuisineID="+cuisineId+"&categoryID="+categoryId+"&priceID="+priceFilterId+"&lifestyleID="+lifestyleFilterId+"&distance="+distanceFilterId+"&page="+pageNum+"&maxResults=25",
			dataType:"xml",
			cache: true,
