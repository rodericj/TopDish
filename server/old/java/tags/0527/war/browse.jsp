...
<%
	...
	*/
	Set<Tag> cuisines = TagUtils.getTagsByType(Tag.TYPE_CUISINE);
...
<%
	...
	*/
	Set<Tag> prices = TagUtils.getTagsByType(Tag.TYPE_PRICE);
	out.print("<option value=\"\">All</option>");
	for (Tag p : prices) {
...
<%
	...
	Set<Dish> dishResults = TDQueryUtils.filterDishes(maxResults, tagKeysToFilter, maxDistance,
