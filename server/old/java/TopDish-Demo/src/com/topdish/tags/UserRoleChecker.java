	 			...
	 			if(UserServiceFactory.getUserService().isUserAdmin()){
	 				...
	 				try{
	 					...
	 					if(action!=null )
		 				{
	 						...
	 						{
	 		 					if(dishId!=null){
	 		 						isAccessAllowed=TDQueryUtils.isAccessible(Long.valueOf(dishId), new Dish());
	 		 					}
	 						}
		 				}
	 					...
	 					if(dishId!=null){
	 						...
	 						isAccessAllowed=TDQueryUtils.isAccessible(Long.valueOf(restaurantId), new Restaurant());
	 					}
	 					else if(tagId!=null){
	 						isAccessAllowed=TDQueryUtils.isAccessible(Long.valueOf(tagId), new Tag());
	 					}	
	 				}
