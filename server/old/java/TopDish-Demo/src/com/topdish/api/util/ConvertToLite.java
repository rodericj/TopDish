...
public final class ConvertToLite{
	...
	public static List<DishLite> convertDishes(Collection<Dish> dishes){
	...
	public static List<RestaurantLite> convertRestaurants(Collection<Restaurant> restaurants){
