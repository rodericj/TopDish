 ...
 */
@PersistenceCapable
public class Restaurant implements TDPersistable, LocationCapable, Serializable {
	/**
	 * 
	 */
	...
	/** 
	 * Fetches all dishes this restaurant has
	 * 
	...
	public void addDish(Key k) {
		...
		// Check for an invalid number of dishes
		if (null == this.numDishes)
		    this.numDishes = 0;
	...
	public void setCuisine(Key cuisine) {
		...
		BatchDishUpdate.setCuisine(cuisine, this.dishes);
	}
