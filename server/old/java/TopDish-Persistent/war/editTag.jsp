...
<%
	...
	if(t.getParentTag() != null){
		parent = (Tag)pm.getObjectById(Tag.class, t.getParentTag());
	}
	int type = t.getType();
%>
...
<form action="updateTag" method="post">
	<label>Name: <input type="text" name="name" value="<% out.print(t.getName()); %>"></input></label><br />
	<label>Description: <input type="text" name="description" value="<% out.print(t.getDescription()); %>"></input></label><br />
	<input type="hidden" name="id" value="<% out.print(t.getKey().getId()); %>"></input>
	<label>Type: 
		<select name="type">
			...
			<option <% if(type == Tag.TYPE_LIFESTYLE) out.print("selected"); %> value="<% out.print(Tag.TYPE_ALLERGEN); %>">Allergen</option>
	...
	<label>Parent Tag: <input type="text" name="parent" id="tag_parent" value="<% if(parent != null) out.print(parent.getName()); %>"></input></label><br />
	<label>Manual Order: <input type="text" name="manual_order" value="<%=t.getManualOrder()%>"></input></label><br />
	<input type="hidden" name="parentID" id="tag_parent_id" value="<% if(parent != null) out.print(parent.getKey().getId()); %>"></input>
