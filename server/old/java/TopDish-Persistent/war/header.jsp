                        ...
                        <div class="search">
                            <form action="search.jsp" method="post">
							  ...
							  %>
                               	  ...
                               	  <input class="locationbox locationbox_up" name="loc" id="loc" type="text" value="${sessionScope.userAddress}" />
                               	  ...
                               	  <input type="hidden" name="locHidden" id="locHidden" value="${sessionScope.userAddress}"/>
                                </fieldset>
                            </form>
                        </div>
