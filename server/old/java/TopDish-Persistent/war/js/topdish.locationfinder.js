...
function addDishesToMap() {
	...
	if(tdmap){
		...
		dishNames = $('.dish_name');
		var dishAddresses = new Array()
		dishAddresses = $('.dish_listing_address');
		var i = 0;
			    
		dishNames.each(function(){
			var bubbleText = "<b>" + $(this).text() + "</b><br>" + $(dishAddresses[i]).text();
	    	...
	    	var infowindow = new google.maps.InfoWindow({content: bubbleText});
