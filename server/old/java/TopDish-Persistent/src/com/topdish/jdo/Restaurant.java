 ...
 */
@PersistenceCapable
public class Restaurant implements TDPersistable, LocationCapable {
	/**
	...
	/**
	 * A list of keys representing the dishes at this restaurant
	 */
	@Persistent
	private transient List<Key> dishes;
	 ...
	 */
	@Persistent
	private transient Set<String> addressTerms;
	 ...
	 *            - who created it
	 */
	public Restaurant(String name, String addressLine1, String addressLine2,
			String city, String state, String neighborhood, double latitude,
			double longitude, PhoneNumber phone, String gid, Link url,
	...
	public Integer getNumDishes() {
		if (this.dishes == null) {
			...
			this.numDishes = this.dishes.size();
	...
	public void setName(String name) {
		this.name = name;
		this.searchTerms = AbstractSearch.getSearchTerms(this.name);
		BatchDishUpdate.setRestaurantName(name, this.dishes);
	}
	...
	public void setCity(String city) {
		...
		BatchDishUpdate.setCity(city, this.dishes);
	}
	...
	public void setState(String state) {
		...
		this.state = state;
		BatchDishUpdate.setState(state, this.dishes);
	}
	...
	public void setNeighborhood(String neighborhood) {
		...
		this.neighborhood = neighborhood;
		BatchDishUpdate.setNeighborhood(neighborhood, this.dishes);
	}
	...
	public void setLocation(double latitude, double longitude) {
		...
		this.geoCells = GeocellManager.generateGeoCell(new Point(this.latitude,
				this.longitude));
		BatchDishUpdate.setLocation(this.latitude, this.longitude,
				this.geoCells, this.dishes);
	}
	...
	/**
	 * Adds a {@link Key} of a dish to be added to this restaurant
	 * 
	 * @param k
	 *            a {@link Key} of a dish to be added to this restaurant
	 * @deprecated Not necessary any more since getDishes uses GQL Query
	 */
	public void addDish(Key k) {
		if (this.dishes == null) {
	...
	/**
	 * Adds a {@link Key} of a dish to be removed from this restaurant
	 * 
	 * @param k
	 *            a {@link Key} of a dish to be removed from this restaurant
	 * 
	 */
	public void removeDish(Key k) {
		this.dishes.remove(k);
		this.numDishes--;
	}
