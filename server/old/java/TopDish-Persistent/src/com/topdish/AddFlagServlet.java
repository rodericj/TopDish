	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)throws IOException{
		...
		if(dishID != 0){
			try{
				...
				flag.setStatus(1);
				flag.setDish(dish.getKey());
				flag.setFlagFor("dish");
			...
			try{
				...
				flag.setStatus(1);
				flag.setRestaurant(restaurant.getKey());
				flag.setFlagFor("restaurant");
			...
			if(reviewID != 0){
				try{
					...
					flag.setStatus(1);
					flag.setReview(review.getKey());
					flag.setFlagFor("review");
			...
			if(photoID != 0){
				try{
					...
					flag.setStatus(1);
					flag.setPhoto(photo.getKey());
					flag.setFlagFor("photo");
