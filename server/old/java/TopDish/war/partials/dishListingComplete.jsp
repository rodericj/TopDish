...
<%
	...
	if(null == uploadURL || uploadURL.equals("")){
		final BlobstoreService blobstoreService = BlobstoreServiceFactory.getBlobstoreService();
		uploadURL = blobstoreService.createUploadUrl("/addReview");
	}
...
%>
	<div class="upVotePanel votePanel" style="display:none;">
		<form action="<%= uploadURL %>" method="post" id="reviewDishForm" enctype="multipart/form-data">
...
<%					} %>
                    ...
                    <div class="dish_listing_text">
                        ...
                        <user:isUserInRole roles="${administrator},${standard},${advanced}" dishId="${dishId}" req="${req}">
