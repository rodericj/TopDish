...
<%@ page import="com.topdish.util.Urls" %>
...
<%
	...
	final String thisUrl = Urls.shorten(request);
%>
               ...
               <div class="menu_disp_detailed">
				...
				<jsp:include page="/blocks/ratingBoxDirectToReview.jsp">
                   ...
                   <h3>General Description</h3>
					...
					Set<Key> sourceKeys = d.getSources().keySet();
					
					if(!sourceKeys.isEmpty()) { 
					 out.print("<p> Sourced from: ");
					 ...
					 while(sources.hasNext()) {
						...
						out.print("<a href=\""+source.getUrl().getValue()+"\">"+source.getName()+"</a>" + (sources.hasNext() ? ", " : ""));
					 }
                    ...
                    %>
						...
						<% if(null != thisUrl){ %>
	                        <br />
	                        <div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="<%= thisUrl %>" send="true" layout="button_count" width="1" show_faces="false" font=""></fb:like>
	                        <div id="google_btn" class="share_button">
								<g:plusone size="medium" href="<%= thisUrl %>" count=false></g:plusone>
							</div>
	                        <div id="twitter_btn" class="share_button">
	                        	<a href="http://twitter.com/share" class="twitter-share-button" data-url="<%= thisUrl %>" data-text="" data-count="none" data-via="topdishinc">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>                        
	                    	</div>
                    	<% } %>
                    </div>
