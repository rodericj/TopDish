...
public class APIUtils {
	...
	public static String generateJSONSuccessMessage(String message) {
		try {
			return generateJSONSuccessMessage(message.length() > 0 ? new JSONObject().put(
					APIConstants.RETURN_MESSAGE, message) : new JSONObject());
	...
	/**
	 * Add Success to existing {@link JSONObject} with a message.
	 * 
	 * @param json
	 *            - the current json object
	 * @param message
	 ...
	 * @return properly formatted json success
	 */
	public static String generateJSONSuccessMessage(JSONObject json, String message) {
		try {
	 ...
	 */
	public static String generateJSONSuccessMessage(String key, JSONArray jsonArray) {

		try {
			return generateJSONSuccessMessage(new JSONObject().put(key, jsonArray));
		} catch (JSONException e) {
			e.printStackTrace();
		}
		return generateJSONSuccessMessage();
	 ...
	 */
	public static String generateJSONFailureMessage(JSONObject json, String message) {
		return generateJSONFailureMessage(APIConstants.RETURN_FAILURE, json, message);
	}
	 ...
	 */
	public static String generateJSONFailureMessage(int returnCode, String message) {
	 ...
	 */
	public static String generateJSONFailureMessage(int returnCode, JSONObject json, String message) {
		try {
