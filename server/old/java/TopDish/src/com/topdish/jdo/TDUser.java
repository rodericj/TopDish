...
public class TDUser implements TDPersistable, Serializable {
	...
	@Persistent
	private Set<Key> flags;

	@Persistent
	private Set<Key> lifestyles;

	@Persistent
	private Set<Key> allergens;
	...
	public Set<Key> getLifestyles() {
		return this.lifestyles;
	}

	public void setLifestyles(Set<Key> lifestyles) {
		this.lifestyles = lifestyles;
	}

	public Set<Key> getAllergens() {
		return this.allergens;
	}

	public void setAllergens(Set<Key> allergens) {
