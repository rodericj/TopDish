...
@PersistenceCapable
public class Review implements TDPersistable, Serializable {
	...
	/**
	 * Constructor to create a review with a photo
	 * 
	 * @param dish
	 * @param direction
	 * @param comment
	 ...
	 * @param photo
	 */
	public Review(Key dish, int direction, String comment, Key creator, Key photo){
		this.dish = dish;
		this.direction = direction;
		this.comment = comment;
		this.dateCreated = new Date();
