...
<div class="rating_box <% out.print(cssFloat); %>">
     ...
     <% if (_starRating != null)  { 
     	...
     	if (starRating > 0.01) {
     		if (starRating > STAR_MAX) starRating = STAR_MAX;
     %>
	 <div id="star-<%= dishID %>">
        ...
        <input type="radio" name="newrate" value="6" />
        <input type="radio" name="newrate" value="7" />
        <input type="radio" name="newrate" value="8" />
    </div>
