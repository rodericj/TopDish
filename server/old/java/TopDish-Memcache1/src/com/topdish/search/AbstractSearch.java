...
public abstract class AbstractSearch {        
	...
	public static List<Restaurant> searchRestaurants(List<String> queryWords, PersistenceManager pm, 
		...
		try{
			result = GeocellManager.proximityFetch(center, maxResults, maxDistance, new Restaurant(), baseQuery, pm);
		}catch(Exception e){
			e.printStackTrace();
		}
	...
	public static List<Dish> searchDishes(List<String> queryWords, PersistenceManager pm, double lat, double lng, 
		...
		try{
			result = GeocellManager.proximityFetch(center, maxResults, maxDistance, new Dish(), baseQuery, pm);
		}catch(Exception e){
			e.printStackTrace();
		}
