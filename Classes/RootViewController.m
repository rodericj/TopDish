...
- (void)viewDidLoad {
   ...
   // UIBarButtonItem *addButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAdd target:self action:@selector(insertNewObject)];
	...
	UIBarButtonItem *addButton = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"greenup.gif"] style:UIBarButtonItemStylePlain target:self action:@selector(insertNewObject)];

	
	//[addButton setCustomView:imageView];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
	...
	//NSLog(@"here we are using the managed Object %@", managedObject.name);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	NSLog(@"%@", [selectedObject dish_name]);
	 
	//NSError *error;
//	NSArray *items = [self.managedObjectContext
//					   executeFetchRequest:fetchRequest error:&error];
//	Dish *thisDish = [items objectAtIndex:[indexPath row]];
