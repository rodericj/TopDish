//
//  ThirdPartyRestaurantTableViewController.m
//  TopDish
//
...
@synthesize restaurants = mRestaurants;
...
+(ThirdPartyRestaurantTableViewController *) viewControllerWithDelegate:(id)delegate {
	ThirdPartyRestaurantTableViewController *tvController = [[[ThirdPartyRestaurantTableViewController alloc] 
															 initWithNibName:@"ThirdPartyRestaurantTableViewController" 
															 bundle:nil] autorelease];
	tvController.delegate = delegate;
	return tvController;
}
#pragma mark -
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return self.restaurants ? self.restaurants.count : 0;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    */
	[self.delegate restaurantSelected];
}
